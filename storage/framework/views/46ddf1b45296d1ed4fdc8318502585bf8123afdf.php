...
<div class="wrapper" id="app">
    ...
    <?php endif; ?>
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a href="/home" class="d-block text-capitalize"><?php echo e(Auth::user()->firstname); ?> <?php echo e(Auth::user()->lastname); ?></a>
          </div>
        </div>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2018 <a href="https://agronegosyo.com">Agronegosyo Technologies Inc.</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
...
<script src="<?php echo e(asset('js/wysihtml5.js')); ?>"></script>
